...
class _SignUpState extends State<SingUp> {
        ...
        child: Align(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
                ...
                hintText: '근무지를 입력해주세요(ex 대전 동구 자양동)',
                helperStyle: TextStyle(color: Colors.black38, fontSize: 30.sp)),
          ),
        ),
      ),
                ...
                try {
                  ...
                  if (Datainfo["${_CdController.text}"] != null &&
                    ...
                    firestore
                      ...
                      "근무지": _CdController.text    
                    });
                  } else if (Ck == false) {
                    FailCk();
                  } else if (Datainfo["${_CdController.text}"] == null) {
                    FailCd();
  ...
  Future Failpasswordvalue() => showDialog(
      context: context,
      builder: (context) => AlertDialog(
            title: Text(
