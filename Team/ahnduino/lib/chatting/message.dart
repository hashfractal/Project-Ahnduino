import 'package:ahnduino/chatting/chat_bubble.dart';
    ...
    return StreamBuilder(
      ...
      builder: (context,
        ...
        chatDocs.forEach((element) {
          ...
          if (chatDate !=
              DateFormat('yyyy-MM-dd').format(now.toDate()).toString()) {
            chatDate = DateFormat('yyyy-MM-dd').format(now.toDate()).toString();
            chatinglist.add(ChatBubbles(
              chatDate,
              element['chat'] == chat!.email,
              element['time'],
              true,
              alllist: allurl,
            ));
            chatinglist.add(ChatBubbles(
                element['text'], element['type'], element['time'], false,
                alllist: allurl));
          } else {
            chatinglist.add(
              new ChatBubbles(
