...
class _BoardViewState extends State<BoardView> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> likeSend()
    async {
      if(likedUser.contains(FirebaseAuth.instance.currentUser!.email.toString()))
        {
          if (mounted) {
            ...
            child: Row(
              ...
              children: const [
                Padding(
                  ...
                  child: Icon(
                    Icons.edit_notifications_rounded,color: Colors.black,
            ...
            children: <Widget>[
              ...
              StreamBuilder(
                  ...
                  builder: (context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                    ...
                    return Row(
                      children:[Text("추천 : " + doc['likes'].toString()
                      ),
